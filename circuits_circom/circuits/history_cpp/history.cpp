...
void historySelector_2_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void historySelector_2_run(uint ctx_index,Circom_CalcWit* ctx);
Circom_TemplateFunction _functionTable[3] = { 
Num2Bits_0_run,
LessThan_1_run,
historySelector_2_run };
uint get_main_input_signal_start() {return 2;}

uint get_main_input_signal_no() {return 3;}

uint get_total_signal_no() {return 262;}
...
ctx->componentMemory[coffset].templateName = "historySelector";
ctx->componentMemory[coffset].signalStart = soffset;
...
historySelector_2_create(1,0,ctx,"main",0);
historySelector_2_run(0,ctx);
}
